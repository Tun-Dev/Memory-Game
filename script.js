...
let cardSymbols = ['twitter-square', 'reddit', 'telegram',
    'snapchat-square', 'whatsapp', 'facebook-square', 'linkedin', 'instagram',
    'twitter-square', 'reddit', 'telegram',
    'snapchat-square', 'whatsapp', 'facebook-square', 'linkedin', 'instagram'];
...
//Convert min, hour & seconds into string
